...
## Status: NOT STARTED ❌ Low priority (93 hosts)

## Old Zabbix source
- Old template name(s): `ZENTRO_*_POSITRON_GAM`
- Host count: 93
- Old Zabbix group: TBD

## Planned new Zabbix template(s)
- Name: TBD (e.g. `.Positron GAM by SNMP`)
- Template groups: `Positron`, `ITcare`, `Templates/Network devices`
- Tag: `target: positron`
...
- IP: TBD
- SNMP community: TBD
- Model: GAM (confirm exact model name from old Zabbix)
...
device_role = [ ]   ← TBD (GAM = Gateway Access Module?)
